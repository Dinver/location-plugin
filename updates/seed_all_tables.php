...
class SeedAllTables extends Seeder
{
  ...
  $es = Country::whereCode('ES')->first();
        ...
        $by = Country::whereCode('BY')->first();
        $by->states()->createMany([
            ['code' => 'BY-HM', 'name' => 'Минск'],
            ['code' => 'BY-BR', 'name' => 'Брестская область'],
            ['code' => 'BY-VI', 'name' => 'Витебская область'],
            ['code' => 'BY-HO', 'name' => 'Гомельская область'],
            ['code' => 'BY-HR', 'name' => 'Гродненская область'],
            ['code' => 'BY-MI', 'name' => 'Минская область'],
            ['code' => 'BY-MA', 'name' => 'Могилёвская область']
        ]);
        ...
        $ua->states()->createMany([
            ['code' => 'UA-30', 'name' => 'Киев'],
            ['code' => 'UA-05', 'name' => 'Винницкая область'],
            ['code' => 'UA-07', 'name' => 'Волынская область'],
            ['code' => 'UA-12', 'name' => 'Днепропетровская область'],
            ['code' => 'UA-14', 'name' => 'Донецкая область'],
            ['code' => 'UA-18', 'name' => 'Житомирская область'],
            ['code' => 'UA-21', 'name' => 'Закарпатская область'],
            ['code' => 'UA-23', 'name' => 'Запорожская область'],
            ['code' => 'UA-26', 'name' => 'Ивано-Франковская область'],
            ['code' => 'UA-32', 'name' => 'Киевская область'],
            ['code' => 'UA-35', 'name' => 'Кировоградская область'],
            ['code' => 'UA-09', 'name' => 'Луганская область'],
            ['code' => 'UA-46', 'name' => 'Львовская область'],
            ['code' => 'UA-48', 'name' => 'Николаевская область'],
            ['code' => 'UA-51', 'name' => 'Одесская область'],
            ['code' => 'UA-53', 'name' => 'Полтавская область'],
            ['code' => 'UA-56', 'name' => 'Ровненская область'],
            ['code' => 'UA-59', 'name' => 'Сумская область'],
            ['code' => 'UA-61', 'name' => 'Тернопольская область'],
            ['code' => 'UA-63', 'name' => 'Харьковская область'],
            ['code' => 'UA-65', 'name' => 'Херсонская область'],
            ['code' => 'UA-68', 'name' => 'Хмельницкая область'],
            ['code' => 'UA-71', 'name' => 'Черкасская область'],
            ['code' => 'UA-74', 'name' => 'Черниговская область'],
            ['code' => 'UA-77', 'name' => 'Черновицкая область']
        ]);
    }
}
